    ...
    <el-col :span="17" style="padding-left: 200px">
      <div class="menu">
        ...
        >
          ...
          <el-menu-item index="/client/ModelTrain">
...
export default {
  ...
  created() {
    ...
    //         this.userAvatar = window.URL.createObjectURL(blob);
    //       }
    //     });
    // }
  },
  methods: {
    ...
    hasToken() {
      ...
      if (token) {
        // axios({
        //   method: "post",
        //   url: `http://localhost:9000/user/download/avatar`,
        //   headers: {
        //     token: token,
        //   },
        //   timeout: 30000,
