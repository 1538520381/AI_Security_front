  ...
  <div>
    ...
    >
        ...
        <el-col :span="8" :offset="0">
          <div class="Echarts">
            <div style="width: 382px; height: 250px; font-size: 14px">
              <p style="padding-top: 80px">总样本数量：{{ n }}</p>
              <p>样本类别种类：{{ n2 }}</p>
              <p>特征数量：{{ n3 }}</p>
            </div>
          </div>
      ...
      <el-row class="menu">
        ...
        <el-col :span="8" :offset="0">
          <div class="Echarts">
            <div id="heatmap" style="width: 390px; height: 250px"></div>
          </div>
        </el-col>
      </el-row>
    </div>
    ...
    >
      ...
      <el-row class="menu">
        <el-col :span="8" :offset="0">
          <div class="Echarts">
            <div style="width: 382px; height: 250px; font-size: 14px">
              <p style="padding-top: 80px">总样本数量：{{ nAfter }}</p>
              <p>样本类别种类：{{ n2After }}</p>
              <p>特征数量：{{ n3After }}</p>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    uploadFile(item) {
      ...
      axios({
        method: "post",
        url: `/localRequest/file/upload?user_id=${this.userId}&data_name=${dataName}`,
        ...
        if (result.code === 200) {
          ...
          axios({
            method: "get",
            url: `/localRequest/file/showDetail1?url=${this.data_url}&type=${this.type}`,
            headers: this.headers,
          })
            .then((res) => {
              // 在这里展示图表,可视化数据
